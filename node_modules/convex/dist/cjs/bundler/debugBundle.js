...
`
      ...
      (0, import_context.logError)(ctx, "It would help to avoid importing this file.");
      ...
      if (chain.length > 0) {
        ...
        if (chain.length === 1) {
          (0, import_context.logError)(ctx, `  ${problematicFileRelative}`);
        } else {
          (0, import_context.logError)(ctx, `  ${problematicFileRelative} is imported by`);
          for (let i2 = 1; i2 < chain.length - 1; i2++) {
            const fileRelative = formatFilePath(dir, chain[i2]);
            (0, import_context.logError)(ctx, `  ${fileRelative}, which is imported by`);
          }
...
`
      ...
      (0, import_context.logFailure)(ctx, "Bundling failed");
      return await ctx.crash({
        exitCode: 1,
        errorType: "invalid filesystem data",
    ...
    (0, import_context.logVerbose)(ctx, `${entryPoint} bundled`);
  }
}
